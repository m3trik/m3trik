...
| [blendertk](https://github.com/m3trik/blendertk) | Blender 4.x+ tech-art toolkit — mirrors mayatk's public API (name and behavior) so the shared tool panels stay branch-free. |
