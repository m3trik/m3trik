...
- `mayatk` — [`main`](mayatk/env_utils/blender_bridge/templates/_import_scene.py#L1050)
- `mayatk` — [`main`](mayatk/env_utils/blender_bridge/templates/_import_scene_usd.py#L1397)
